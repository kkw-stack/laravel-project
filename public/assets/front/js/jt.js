...
(function(win) {
    ...
    JT.confirm = function( args, cb ){
        ...
        let message, description, isChoice, addClass, confirm, cancel, onConfirm, onCancel;
        ...
        if( addClass ) confirmClass += ` ${ addClass }`;
        ...
        html.innerHTML = `<div class="jt-confirm__container">
                              <div class="jt-confirm__content">
                                  <p class="jt-confirm__message">${message}</p>
                                  ${description ? '<p class="jt-confirm__description">'+ description +'</p>' : ''}
                              </div>
        ...
        html.addEventListener('click', (e) => {
            if( !e.target.closest('.jt-confirm__container') ){
                html.remove();
            }
        });
        ...
        if( !field.validity.valid ) {
            ...
            if( field.validity.valueMissing ) { // Required message
                ...
                if( 'msgRequired' in dataset ) {
                    ...
                    validTip.textContent = '필수 항목을 입력해주세요.';
                }  
                ...
                if( 'msgInvalid' in dataset ) {
                    ...
                    validTip.textContent = '정확한 형식으로 기재해주세요.';
                } 
