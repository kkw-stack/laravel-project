            ...
            <div class="card">
                <div class="card-body">
                    <div class="px-1 py-4">
                        ...
                        @if(Route::is('admin.auth.reset-password-complete'))
                            <hr />
                            <p class="card-text fs-5 mt-4">비밀번호 재설정이 완료되었습니다.</p>
                        @else
                            <form id="pwForm" method="POST" novalidate>
                                ...
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary">비밀번호 설정완료</button>
                                </div>
                            </form>
                        @endif
                    </div>
