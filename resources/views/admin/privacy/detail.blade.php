...
@section('content')
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col-auto">
            <h1 class="page-title fs-4">개인정보처리방침 상세</h1>
        </div><!-- .col -->
    </div><!-- .row -->
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="card-title mb-0">개인정보처리방침 정보</h2>
                    </div><!-- .card-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-0">
                            ...
                            >{{ old('content', $privacy?->content ?? '') }}</textarea>
                            @error('content')
                                <p class="error invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="d-flex gap-1">
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="status" value="1" @checked(old('status', $privacy?->status ?? false)) />
                                        <span>공개</span>
                                    </label>
                                </div><!-- .form-check -->
                                ...
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="status" value="0" @checked(old('status', $privacy?->status ?? false) == false) />
                                        <span>비공개</span>
                                    </label>
                                </div><!-- .form-check -->
                            </div>
                        ...
                        <div class="mb-0">
                            ...
                            <div class="input-group flatpickr js-flatpickr-datetime">
                                <input
                                    ...
                                    value="{{ old('published_at', $privacy?->published_at ?? null)}}"
                                />
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto">
                                <div class="d-flex gap-1">
                                    <button type="submit" class="btn btn-primary">{{ isset($privacy) ? '수정' : '등록' }}</button>
                                    <a href="{{ route('admin.privacy.list', request()->query()) }}" class="btn btn-light" id="postCancel">취소</a>
                                </div>
                            </div><!-- .col -->
